      ...
      <div class="row mt-3" style="padding-right: 15px; padding-left: 15px;">
        ...
        <div class="col-sm-3">
          <div class="input-group flex-nowrap">
            ...
            <input id= "input_customer" type="text" class="form-control" placeholder="Arama.." aria-label="Username" aria-describedby="addon-wrapping">
        <!--    <input id= "search_customer" type="text" class="form-control" placeholder="Arama.." aria-label="Username" aria-describedby="addon-wrapping"> -->
            <button id= "search_customer" class="btn btn-outline-primary">Ara</button>
          </div>
        </div>
      </div>
